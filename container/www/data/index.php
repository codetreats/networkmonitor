...
define('PERMISSIONS', 'editfile,deletefile'); // empty means all
define('PATTERN_FILES', '/^[A-Za-z0-9-_.\/]*\.(txt|cfg)$/i'); // empty means no pattern
		...
		<div class="row p-3">
			...
			<div class="col-md-9">
				...
				<div class="float-right">
					...
					<a href="http://<?= $_SERVER['HTTP_HOST'] ?>" class="btn btn-sm btn-danger"><i class="fas fa-sign-out-alt"></i></a>
